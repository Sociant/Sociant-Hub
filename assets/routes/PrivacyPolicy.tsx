		...
		<LegalPage>
			<Container>
				...
				<p>
					...
					particularly high priority for the management of the Sociant Web-Development. The use of the
					Internet pages of the Sociant Web-Development is possible without any indication of personal data;
				...
				<p>
					...
					accordance with the country-specific data protection regulations applicable to the Sociant
					Web-Development. By means of this data protection declaration, our enterprise would like to inform
				...
				<p>
					As the controller, the Sociant Web-Development has implemented numerous technical and organizational
				...
				<h4>1. Definitions</h4>
				<p>
					The data protection declaration of the Sociant Web-Development is based on the terms used by the
				...
				<p>Sociant Web-Development</p>
				<p>Donaustraße 17</p>
				<p>99089 Erfurt</p>
				<p>Germany</p>
				<p>Phone: 017634517371</p>
				<p>Email: info@sociant.de</p>
				<p>Website: hub.sociant.de</p>
				<h4>3. Cookies</h4>
				<p>
					The Internet pages of the Sociant Web-Development use cookies. Cookies are text files that are
				...
				<p>
					Through the use of cookies, the Sociant Web-Development can provide the users of this website with
				...
				<p>
					The website of the Sociant Web-Development collects a series of general data and information when a
					...
					site, (6) an Internet protocol address (IP address), (7) the Internet service provider of the
				...
				<p>
					When using these general data and information, the Sociant Web-Development does not draw any
					...
					of a cyber-attack. Therefore, the Sociant Web-Development analyzes anonymously collected data and
				...
				<p>
					...
					The controller may request transfer to one or more processors (e.g. a parcel service) that also uses
				...
				<p>
					The website of the Sociant Web-Development contains information that enables a quick electronic
				...
				<ul style={{ listStyle: 'none' }}>
					...
					<li>
						...
						<p>
							...
							erasure of personal data stored by the Sociant Web-Development, he or she may, at any time,
							contact any employee of the controller. An employee of Sociant Web-Development shall
						...
						<p>
							...
							as processing is not required. An employees of the Sociant Web-Development will arrange the
					...
					<li>
						...
						<p>
							...
							restriction of the processing of personal data stored by the Sociant Web-Development, he or
							she may at any time contact any employee of the controller. The employee of the Sociant
							Web-Development will arrange the restriction of the processing.{' '}
						</p>
					</li>
					<li>
						...
						<p>
							...
							any employee of the Sociant Web-Development.
						</p>
					</li>
					<li>
						...
						<p>
							The Sociant Web-Development shall no longer process the personal data in the event of the
						...
						<p>
							If the Sociant Web-Development processes personal data for direct marketing purposes, the
							...
							related to such direct marketing. If the data subject objects to the Sociant Web-Development
							to the processing for direct marketing purposes, the Sociant Web-Development will no longer
						...
						<p>
							...
							situation, to object to processing of personal data concerning him or her by the Sociant
							Web-Development for scientific or historical research purposes, or for statistical purposes
						...
						<p>
							...
							Sociant Web-Development. In addition, the data subject is free in the context of the use of
					...
					<li>
						...
						<p>
							...
							explicit consent, the Sociant Web-Development shall implement suitable measures to safeguard
						...
						<p>
							...
							decision-making, he or she may, at any time, contact any employee of the Sociant
							Web-Development.
						</p>
					</li>
					<li>
						...
						<p>
							...
							any time, contact any employee of the Sociant Web-Development.
						</p>
					</li>
				</ul>
				<h4>9. Data protection provisions about the application and use of Google AdSense</h4>
				<p>
				...
				<p>
					The operating company of Google's AdSense component is Google Ireland Limited, Gordon House, Barrow
				...
				<p>
					...
					to analyze the use of our website. With each call-up to one of the individual pages of this Internet
					site, which is operated by the controller and into which a Google AdSense component is integrated,
				...
				<p>
					...
					from setting a cookie on the information technology system of the data subject. Additionally,
				...
				<p>
					...
					clicked on by the data subject. Tracking pixels serve, inter alia, to analyze the flow of visitors
					on a website.
				</p>
				<p>
				...
				<h4>11. Data protection provisions about the application and use of Google Remarketing</h4>
				<p>
				...
				<p>
					The operating company of the Google Remarketing services is the Google Ireland Limited, Gordon
				...
				<p>
					...
					member of the Google advertising network. With each call-up to an Internet site on which the service
					has been integrated by Google Remarketing, the web browser of the data subject identifies
				...
				<p>
					...
					Google advertising network. Google AdWords allows an advertiser to pre-define specific keywords with
					the help of which an ad on Google's search results only then displayed, when the user utilizes the
				...
				<p>
					...
					certain sub-pages, e.g, the shopping cart from an online shop system, were called up on our website.
					Through the conversion cookie, both Google and the controller can understand whether a person who
					reached an AdWords ad on our website generated sales, that is, executed or canceled a sale of goods.
				</p>
				<p>
				...
				<p>
					...
					e.g. short messages, which are limited to 280 characters. These short messages are available for
					everyone, including those who are not logged on to Twitter. The tweets are also displayed to
					so-called followers of the respective user. Followers are other Twitter users who follow a user's
					tweets. Furthermore, Twitter allows you to address a wide audience via hashtags, links or retweets.
				</p>
				<p>
					The operating company of Twitter is Twitter International Company, One Cumberland Place, Fenian
				...
				<p>
					If the data subject is logged in at the same time on Twitter, Twitter detects with every call-up to
					...
					collected through the Twitter component and associated with the respective Twitter account of the
					data subject. If the data subject clicks on one of the Twitter buttons integrated on our website,
					then Twitter assigns this information to the personal Twitter user account of the data subject and
				...
				<p>
					...
					that was developed in cooperation with <a href="https://www.wbs-law.de/eng/">German Lawyers</a> from
