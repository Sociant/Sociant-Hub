...
import { TwitterUser, UsersResponse } from '../types/global'
...
export default function Followers() {
	...
	const loadData = async (_page = page) => {
		...
		if (users == null) setUsers(responseData.items)
		else setUsers([...users, ...responseData.items])
	...
	const getTitle = () => {
		if (type === 'verified') return 'profile.followersVerified'
